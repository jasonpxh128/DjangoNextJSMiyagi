        ...
        <div className="relative h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[600px] 2xl:h-[700px] z-10">
            ...
            <div className=" absolute top-1/4 justify-center w-full text-center z-20 flex flex-row">
                <div className="  text-center uppercase ">
                    ...
                    <button className="text-white text-lg px-10 py-2 shadow-md  rounded-full uppercase mt-1 font-normal transition duration-150 ease-out hover:text-red-600 hover:scale-110 ">{buttontext}</button> 
                </div>
            </div>
